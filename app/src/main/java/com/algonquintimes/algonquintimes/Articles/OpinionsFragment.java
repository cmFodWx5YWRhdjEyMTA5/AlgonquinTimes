...
public class OpinionsFragment extends Fragment {
    ...
    public File file;
    private OpinionsModel postModel;
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        Config.base_url = "http://algonquintimes.com/wp-json/wp/v2/posts?_embed=true&page=1&per_page=20&categories=9";
        ...
        postModel = ViewModelProviders.of(getActivity()).get(OpinionsModel.class);
