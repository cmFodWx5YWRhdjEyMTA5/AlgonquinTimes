...
public class InnovationsModel extends AndroidViewModel {
    ...
    public InnovationsModel(@NonNull Application application) {
        super(application);
        if (postsList == null)
                    ...
                    for (int i = 0; i < response.length(); i++) {
                        ...
                        try {
                            ...
                            if (featureImageCheck > 0) {
                                ...
                                //Log.d(TAG, featureThumbnailObj.getString("source_url"));
                            }
                            if (fiurl != null) {
