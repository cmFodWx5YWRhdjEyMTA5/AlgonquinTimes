...
public class SportsFragment extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        Config.base_url = "http://algonquintimes.com/wp-json/wp/v2/posts?_embed=true&page=1&per_page=20&categories=11";
        ...
        postModel = ViewModelProviders.of(getActivity()).get(SportsModel.class);
