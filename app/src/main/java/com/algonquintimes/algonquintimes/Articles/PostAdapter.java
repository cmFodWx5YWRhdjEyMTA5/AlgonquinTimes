...
public class PostAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof header) {
            ...
            ((VideoViewHolder) holder).date = post.getExcerpt();
            ((VideoViewHolder) holder).link = post.getPostURL();
            ((VideoViewHolder) holder).author = post.getPostAuthor();
        ...
        public VideoViewHolder(View v) {
            ...
            v.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    fullScreenIntent.putExtra("date", date);
                    fullScreenIntent.putExtra("link", link);
                    fullScreenIntent.putExtra("author", author);
