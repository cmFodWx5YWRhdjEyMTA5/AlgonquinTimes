...
public class ThirdFragment extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        recyclerView = getActivity().findViewById(R.id.recyclerEvent3);
        ...
        postModel = ViewModelProviders.of(getActivity()).get(ThirdModel.class);
